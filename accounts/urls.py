...
urlpatterns = [
    ...
    path('profile/password/start/', PasswordChangeStartView.as_view(), name='password-change-start'),
    path('profile/password/confirm/', PasswordChangeConfirmView.as_view(), name='password-change-confirm'),
    path('profile/password/cancel/', PasswordChangeCancelView.as_view(), name='password-change-cancel'),
