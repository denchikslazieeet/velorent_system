...
OPERATOR_NOTIFICATION_EMAILS = env_list(
    "OPERATOR_NOTIFICATION_EMAILS",
    "velo-rent.official@yandex.com",
)
EMAIL_RETRY_DELAY_MINUTES = env_int("EMAIL_RETRY_DELAY_MINUTES", 10)
EMAIL_MAX_ATTEMPTS = env_int("EMAIL_MAX_ATTEMPTS", 5)
